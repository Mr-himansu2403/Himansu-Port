...
<span className="text-blue-600">scalable & responsive web applications</span>{" "}
using modern technologies. Experienced in{" "}
<span className="text-purple-600">Java & Spring Boot</span>,{" "}
<span className="text-pink-600">React.js & Node.js</span>, and{" "}
<span className="text-orange-600">PostgreSQL</span>, with expertise in{" "}
<span className="text-green-600">RESTful APIs</span>,{" "}
<span className="text-indigo-600">AI-powered development tools</span>, and{" "}
<span className="text-red-600">user-centric UI/UX design</span>{" "}
